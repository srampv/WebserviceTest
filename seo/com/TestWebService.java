 ...
 * 
 */
@WebServiceClient(name = "TestWebService", targetNamespace = "urn:com.seo", wsdlLocation = "http://www.ramthoughts.com/TestWS/TestWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TESTWEBSERVICE_QNAME = new QName("urn:com.seo", "TestWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://www.ramthoughts.com/TestWS/TestWebService?wsdl");
    ...
    public TestWS getTestWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("urn:com.seo", "TestWSPort"), TestWS.class, features);
    }
